...
int main(int argc, string argv[])
{
    ...
    else //if users types nr 2 arguments, the code checks if the second argument is made up of just numeric digits
    {
        ...
        {
            //if one of the characters of the second command line argument are letters or a 0 or a negative integer, print an error message and exit
    ...
    //converts the second argument into an int, in order to be used later as key
    int key = atoi(argv[1]);
    ...
    for (int i = 0; i < strlen(pltext); i++)
    {
        ...
        //checks if character is alphabetic, preserving the case; then rotates it and prints it
        if (isalpha(pltext[i]))
        {
